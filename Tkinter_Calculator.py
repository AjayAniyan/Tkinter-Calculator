...
Button(root,text='0',command=lambda :get_variable(0)).grid(row=2,column=3)
...
Button(root,text='=',command=lambda :calculate()).grid(row=4,column=4)
Button(root,text='AC',command=lambda :clearall()).grid(row=4,column=5)
Button(root,text='%', command=lambda :get_operation('%')).grid(row=5,column=0)
Button(root,text='un',command=lambda :undo()).grid(row=5,column=1)
Button(root,text='x!').grid(row=5,column=2)
...
Button(root,text='exp', command=lambda :get_operation('**')).grid(row=3,column=3)
